...
/**
 * Generate WordPress-style sitemaps for bermo.ro
 * Creates:
...
// Categories
const categories = [
  { name: 'Electrocasnice Premium', slug: 'electrocasnice-premium' },
  { name: 'IT si Electronice', slug: 'it-electronice' },
  { name: 'Mobilier si Dormitor', slug: 'mobilier-dormitor' },
  { name: 'Fitness si Sport', slug: 'fitness-sport' }
];
...
<head>
  <title>XML Sitemap - Bermo.ro</title>
  ...
  <style type="text/css">
    ...
    h1 { color: #059669; border-bottom: 3px solid #10b981; padding-bottom: 10px; }
    ...
    .count { background: #10b981; color: white; padding: 2px 8px; border-radius: 12px; font-size: 12px; }
  </style>
</head>
<body>
  <h1>XML Sitemap</h1>
